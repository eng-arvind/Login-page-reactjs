            ...
            <div className="main">
                ...
                <form className="form" action="">
                    <div className="form-field">
                        ...
                        <input type="email" placeholder="Enter Your Registered Email" name="psw" required />
                    </div>
                    <div className="form-field">
